...
# 테스트 파일 로드할때 경로 이케하셈 위에는 너무 양이 많음 
test_directory_path = 'venv/data/raw'
test_directories = ["조선시대/조선 후기의 정치"]
...
if __name__ == "__main__":
    ...
    # test file 경로 아래 경로로 저장
    test_pickle_file_path = "venv/data/processed/test2_documents.pkl"

    # 문서 로드
    documents = load_pdfs_from_directory(test_directory_path, test_directories)
